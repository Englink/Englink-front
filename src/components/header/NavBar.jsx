...
import { useNavigate } from 'react-router-dom'; // יבוא של useNavigate
import SignupTeachersModal from '../modal/SignupTeachersModal.jsx';

const SlideNavbar = () => {
    const [isMenuOpen, setIsMenuOpen] = useState(false);
    const navigate = useNavigate(); // השמת useNavigate למשתנה

    const toggleMenu = () => {
        setIsMenuOpen(!isMenuOpen);
    };

    // פונקציה לניווט ל/user-profile
    const handleProfileClick = () => {
        navigate('/user-profile'); // שימוש בפונקציה navigate
    };
